...
st.subheader("Note # 1: Current functions include Top 10 best tags and word cloud for English-based models. These outputs are set to return for the sample output below:")
...
st.subheader("Note # 2: Currently, only word cloud for English-based models and Top 10 tag functions exist in our 'Advanced Users' section. Future updates are set to include the below additional functions:")
